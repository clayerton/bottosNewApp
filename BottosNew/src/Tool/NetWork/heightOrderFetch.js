...
import { getRequestBody, getRequestURL } from "../FunctionTool";
 ...
 */
export function requestWithBody(url, body, callback) {
...
function _postFormData(url, formData) {
    let requestURL = getRequestURL() + Config.URLSuffix + url;
 ...
 * @param formData
 */
export function requestWithFile(url, formData) {
    // 用户及设备信息
